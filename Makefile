...
BUILD_DIR=build
SOURCES=$(BUILD_DIR)/main.o $(BUILD_DIR)/coder.o $(BUILD_DIR)/argumentParser.o
...
$(BUILD_DIR)/main.o: main.cpp coder.h argumentParser.h
	@$(COMPILER) -c $< -o $@

$(BUILD_DIR)/coder.o: coder.cpp coder.h
	@$(COMPILER) -c $< -o $@

$(BUILD_DIR)/argumentParser.o: argumentParser.cpp argumentParser.h
	@$(COMPILER) -c $< -o $@
